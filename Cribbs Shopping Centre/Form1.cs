    ...
    public partial class Form1 : Form
    {
        void searchFunction(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyValue == Convert.ToInt32(Keys.Enter))
            {
                ...
                string checker = "";
                string[] list = { "shopping", "grocery", "map","maps" ,"fire exits", "fire", "gregg", "kfc", "dining","Food","Chicken", "amazon", "Boots", "claires", "Eurochange", "money", "hbeauty", "John Lewis", "Marks spencer", "MS", "SKy", "specsavers", "glasses","superdrug", };
